...
//        sectionRepository.save(Sec);
        ...
        //Sekcja nr1 - podstawy --------------------------------------------------------------------------------------------------
        Exercise basic1Ex1 = new Exercise(null, 2, "Mam na imię Jan", "My name is Jan", "My orange is Juan;You eat Jan", null, ExerciseType.CHOOSE_ANSWER);
        Exercise basic1Ex2 = new Exercise(null, 2, "Jestem mężczyzną", "I am a man", "I am a woman;He is an ant", null, ExerciseType.CHOOSE_ANSWER);
        Exercise basic1Ex3 = new Exercise(null, 2, "Ty jesteś kobietą", "You are w woman", "You are an apple;She is a woman", null, ExerciseType.CHOOSE_ANSWER);
        Exercise basic1Ex4 = new Exercise(null, 2, "selectWords", "", "", null, ExerciseType.SELECT_WORDS);
        Exercise basic1Ex5 = new Exercise(null, 2, "selectWords", "", "", null, ExerciseType.SELECT_WORDS);
        Exercise basic1Ex6 = new Exercise(null, 2, "selectWords", "", "", null, ExerciseType.SELECT_WORDS);
        ...
        Exercise basic1Ex14 = new Exercise(null, 2, "He ... a man", "is", "are;am;", null, ExerciseType.FILL_THE_BLANK);
        Exercise basic1Ex15 = new Exercise(null, 2, "We ... women", "are", "is;am", null, ExerciseType.FILL_THE_BLANK);
        ...
        Exercise animalsEx1 = new Exercise(null, 2, "Kot i pies", "A cat and a dog", "Elephant and ant;Dog and duck", null, ExerciseType.CHOOSE_ANSWER);
        Exercise animalsEx2 = new Exercise(null, 2, "Koty jedzą ryby", "Cats eat fish", "Fish eat cats;Ants eat elephants", null, ExerciseType.CHOOSE_ANSWER);
        Exercise animalsEx3 = new Exercise(null, 2, "Jestem człowiekiem", "I am a human", "I are an apple;She a human", null, ExerciseType.CHOOSE_ANSWER);
        Exercise animalsEx4 = new Exercise(null, 2, "", "", "", null, ExerciseType.SELECT_WORDS);
        Exercise animalsEx5 = new Exercise(null, 2, "", "", "", null, ExerciseType.SELECT_WORDS);
        Exercise animalsEx6 = new Exercise(null, 2, "", "test", "", null, ExerciseType.SELECT_WORDS);
        ...
        Exercise animalsEx14 = new Exercise(null, 2, "... bark", "Dogs", "Ants;Cats", null, ExerciseType.FILL_THE_BLANK);
        Exercise animalsEx15 = new Exercise(null, 2, "... purr", "Cats", "Elephants;Dogs", null, ExerciseType.FILL_THE_BLANK);
